...
ProjectDetail sampleProjectDetail(int id) => ProjectDetail(
      ...
      currency: 'USD',
      status: 'on_track',
      statusLabel: 'في الموعد',
      stages: [
        ProjectStage(titleAr: 'اختيار المنطقة واعتماد الحاجة', progress: 100, state: 'done', approved: true, plannedStart: '2026-03-01', plannedEnd: '2026-03-15'),
        ProjectStage(titleAr: 'اعتماد الميزانية والتصميم', progress: 100, state: 'done', approved: true, plannedStart: '2026-03-16', plannedEnd: '2026-04-15'),
        ProjectStage(titleAr: 'التأسيس والبناء', progress: 100, state: 'done', approved: true, plannedStart: '2026-04-16', plannedEnd: '2026-05-31'),
        ProjectStage(titleAr: 'التشطيب والتجهيز الطبي', progress: 62, state: 'now', approved: true, plannedStart: '2026-06-01', plannedEnd: '2026-07-30'),
        ProjectStage(titleAr: 'الافتتاح وأول مريض', progress: 0, state: 'pending', approved: false, plannedStart: '2026-08-01', plannedEnd: '2026-09-01'),
      ],
      reports: [
